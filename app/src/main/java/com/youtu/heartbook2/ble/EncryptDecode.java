...
public class EncryptDecode {
    ...
    public byte[] Encrypt(byte[] raw) {
        ...
        encrypted = this.Encrypt(encrypted, this.ENCRYPT_KEY_FUCK);
        ...
        encrypted = this.Encrypt(encrypted, this.ENCRYPT_KEY_CPT);
        i = 4;
    ...
    public byte[] Decrypts(byte[] raw) {
        ...
        encrypted = this.Decrypt(encrypted, "CPTBTPTPBCPTTPTP");
        i = 4;
        ...
        encrypted = this.Decrypt(encrypted, "Fuck you! Thief!");
